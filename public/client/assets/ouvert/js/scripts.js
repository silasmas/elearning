...
(function($) {
    ...
    function slider_area() {
        $('.slider-area').owlCarousel({
            ...
            items: 1,
            smartSpeed: 800,
            navText: ['<i><img src="../client/assets/ouvert/images/angle-left.png" alt="icon"/></i><span>prev</span>',
            '<span>next</span><i><img src="../client/assets/ouvert/images/angle-right.png" alt="icon"/></i>']
        });
    };
    slider_area();
